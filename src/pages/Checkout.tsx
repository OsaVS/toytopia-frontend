...
const Cart = () => {
  ...
  return (
    <div>
        <div className='flex flex-col mt-20 mb-10 mr-8 ml-8 md:mx-20'>
            ...
            <div className='flex flex-row justify-between md:grid md:grid-cols-3 gap-4'>
                <div className='hidden md:flex items-center text-left gap-4 pb-6 pr-8 mm:pr-20 md:pr-8 lg:pr-14 text-black border-green-500 border-b-2 text-sm'><div className='flex w-10 h-10 rounded-full bg-green-500 justify-center items-center text-white'><DoneIcon /> </div> <span className='lg:text-xl text-green-500'>Shopping cart</span></div>
                <div className='flex items-center text-left gap-4 pb-6 pr-8 mm:pr-20 md:pr-8 lg:pr-14 text-black border-black border-b-2 text-sm'><div className='flex w-10 h-10 rounded-full bg-black justify-center items-center text-white'>2</div><span className='lg:text-xl'>Checkout details</span></div>
                <div className='flex items-center text-left text-gray-300 gap-4 pb-6 md:pr-8 lg:pr-14 text-sm'><div className='flex w-10 h-10 rounded-full bg-gray-300 justify-center items-center text-white'>3</div><span className='hidden md:block lg:text-xl'>Order complete</span></div>
            </div>
        </div>

        <div className='grid grid-cols-1 md:grid-cols-2 p-8 sd:grid-cols-2 md:px-20'>
