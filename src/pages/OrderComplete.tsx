    ...
    <div>
        <div className='flex flex-col justify-center items-center mt-20 mb-10 mr-8 ml-8 md:mx-20'>
            ...
            <div className='flex flex-row w-full sd:justify-between xl:grid xl:grid-cols-3 gap-4 '>
                <div className='hidden md:flex items-center text-left gap-4 md:gap-2 xl:gap-4 pb-6 pr-8 mm:pr-20 md:pr-8 lg:pr-20 xl:pr-14 text-black border-green-500 border-b-2 text-sm'><div className='flex w-10 h-10 rounded-full bg-green-500 justify-center items-center text-white'><DoneIcon /> </div> <span className='xl:text-xl text-green-500'>Shopping cart</span></div>
                <div className='hidden md:flex items-center text-left gap-4 md:gap-2 xl:gap-4 pb-6 pr-8 mm:pr-20 md:pr-8 lg:pr-20 xl:pr-14 text-black border-green-500 border-b-2 text-sm'><div className='flex w-10 h-10 rounded-full bg-green-500 justify-center items-center text-white'><DoneIcon /> </div><span className='xl:text-xl text-green-500'>Checkout details</span></div>
                <div className='flex items-center text-left gap-4 md:gap-2 xl:gap-4 pb-6 pr-8 mm:pr-20 md:pr-8 lg:pr-20 xl:pr-14 text-black border-black border-b-2 text-sm'><div className='flex w-10 h-10 rounded-full bg-black justify-center items-center text-white'>3</div><span className='xl:text-xl'>Order complete</span></div>
            </div>
